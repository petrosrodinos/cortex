...
const SIDE_EFFECT_TOOL_PATTERN =
  /^(output__create_image|output__create_word|output__create_pdf|output__create_excel|.+__(send_email|send_message|send_html_email|send_bulk_email|send_email_with_attachments))$/;
