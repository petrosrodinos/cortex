...
export class NotionIntegration extends SaasIntegration {
  ...
  protected readonly actions: SaasActionDefinition[] = [
    ...
    },
    {
      ...
      schema: z.object({ parentPageId: optionalString, parentDatabaseId: optionalString, title: optionalString, properties: z.record(z.any()).optional(), children: z.array(z.any()).optional() }),
    ...
    },
    {
      ...
      schema: z.object({ pageId: z.string(), properties: z.record(z.any()).optional(), archived: z.boolean().optional() }),
    ...
    },
    {
      ...
      schema: z.object({ databaseId: z.string(), filter: z.record(z.any()).optional(), sorts: z.array(z.any()).optional(), pageSize: optionalNumber }),
    ...
    },
    {
      ...
      schema: z.object({ parentPageId: z.string(), title: z.string(), properties: z.record(z.any()).optional() }),
    ...
    },
    {
      ...
      schema: z.object({ databaseId: z.string(), title: optionalString, properties: z.record(z.any()).optional() }),
