...
export const PERMISSIONS = [
  ...
  { key: PermissionKeys.INTEGRATIONS_CONNECT, label: 'Connect personal integrations', group: 'integrations' },
  ...
  { key: PermissionKeys.ORG_INTEGRATIONS_MANAGE, label: 'Manage integrations (legacy)', group: 'integrations' },
  { key: PermissionKeys.ORG_INTEGRATIONS_USE, label: 'Use integrations (legacy)', group: 'integrations' },
...
const LEGACY_PERMISSION_KEYS = new Set<string>([
  PermissionKeys.ORG_INTEGRATIONS_MANAGE,
  PermissionKeys.ORG_INTEGRATIONS_USE,
