...
> = {
  [AiProviderTypes.OPENAI]: [
    { value: 'gpt-5.5', label: 'GPT-5.5', search: true, deepResearch: true },
    { value: 'gpt-5.5-pro', label: 'GPT-5.5 Pro', search: true, deepResearch: true },
    { value: 'gpt-5.4', label: 'GPT-5.4', search: true, deepResearch: true },
    { value: 'gpt-5.4-pro', label: 'GPT-5.4 Pro', search: true, deepResearch: true },
    { value: 'gpt-5.4-mini', label: 'GPT-5.4 Mini', search: true },
    { value: 'gpt-5.4-nano', label: 'GPT-5.4 Nano', search: true },
    { value: 'gpt-4.1', label: 'GPT-4.1', search: true },
    { value: 'gpt-4.1-mini', label: 'GPT-4.1 Mini', search: true },
    { value: 'gpt-4.1-nano', label: 'GPT-4.1 Nano', search: true },
  ...
  [AiProviderTypes.CLAUDE]: [
    { value: 'claude-opus-4-8', label: 'Claude Opus 4.8', search: true, deepResearch: true },
    { value: 'claude-sonnet-4-6', label: 'Claude Sonnet 4.6', search: true, deepResearch: true },
    { value: 'claude-opus-4-6', label: 'Claude Opus 4.6', search: true, deepResearch: true },
    { value: 'claude-sonnet-4-5-20250929', label: 'Claude Sonnet 4.5', search: true },
    { value: 'claude-opus-4-1-20250805', label: 'Claude Opus 4.1', search: true },
    { value: 'claude-sonnet-4-20250514', label: 'Claude Sonnet 4', search: true },
    { value: 'claude-opus-4-20250514', label: 'Claude Opus 4', search: true },
    { value: 'claude-haiku-4-5-20251001', label: 'Claude Haiku 4.5', search: true },
    { value: 'claude-3-5-haiku-latest', label: 'Claude 3.5 Haiku', search: true },
    { value: 'claude-3-5-sonnet-latest', label: 'Claude 3.5 Sonnet' },
    { value: 'claude-3-opus-latest', label: 'Claude 3 Opus' },
  ],
  [AiProviderTypes.GROK]: [
    { value: 'grok-4.3', label: 'Grok 4.3', search: true, deepResearch: true },
    { value: 'grok-4.20-reasoning', label: 'Grok 4.20 Reasoning', search: true, deepResearch: true },
    { value: 'grok-4.20-multi-agent', label: 'Grok 4.20 Multi-Agent', search: true, deepResearch: true },
    { value: 'grok-4.20-non-reasoning', label: 'Grok 4.20', search: true },
  ],
};
