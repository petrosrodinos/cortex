export const ApiRoutes = {
    ...
    organizations: {
        ...
        resendIntegrationTest: (organizationUuid: string) => `/organizations/${organizationUuid}/integrations/resend/test`,
        sendgridIntegrationTest: (organizationUuid: string) => `/organizations/${organizationUuid}/integrations/sendgrid/test`,
